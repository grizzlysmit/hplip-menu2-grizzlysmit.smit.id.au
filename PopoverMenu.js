...
export const OverButtonBox = GObject.registerClass(
class OverButtonBox extends St.Widget {
    _init(params) {
        super._init({
            style_class: 'over-button',
            x_expand: true,
            y_expand: true,
            ...params,
        });
...
export const OverButton = GObject.registerClass({
    Signals: {'menu-set': {}},
}, class PanelMenuButton extends OverButtonBox {
...
class PopupOverMenuItem extends PopupMenu.PopupBaseMenuItem {
    _init(text, params) {
        ...
        this.button = new OverButton(this.label.length, text);
